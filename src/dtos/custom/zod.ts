...
const ModuleItem = extendBase({
  kind: z.literal("ModuleItem"),
  moduleSize: ModuleSize,
  controllerType: ControllerType,
})
  .passthrough();
const AccessoryItem = extendBase({
...
const BaseItemInput = z
  ...
  .passthrough();
const GenericItemInput = extendBase({
  kind: z.literal("GenericItem"),
  frameColor: FrameColor,
  modulePackage: ModulePackage,
})
  .passthrough();
const ModuleItemInput = extendBase({
  kind: z.literal("ModuleItem"),
  moduleSize: ModuleSize,
  controllerType: ControllerType,
})
  .passthrough();
const AccessoryItemInput = extendBase({
  kind: z.literal("AccessoryItem"),
